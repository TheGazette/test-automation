Feature: (GCP-REG-T010) Company name validation with incorrect company name on Registration page

  Scenario: There should be an error if company name is incorrect
    Given I navigate to /my-gazette/account?register=true&type=company_profile
    And I fill in the form
      | fieldName                | fieldValue  | fieldType |
      | #organisation-regno      | 10940907    | text      |
      | #organisation-name       | Tweet tweet | text      |
