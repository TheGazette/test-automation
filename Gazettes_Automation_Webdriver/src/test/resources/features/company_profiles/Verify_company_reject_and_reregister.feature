Feature: (GCP-REG-T019)(GCP-REG-T021) Test reject and re-register

  Scenario: Rejection functionality
...
#    And I click supplied_personal_id_link
#    And I wait for 25 seconds
#    Then a file called sample_id.docx should be downloaded to my downloads directory
#    And I click supplied_company_id_link
#    And I wait for 25 seconds
#    Then a file called sample_address.docx should be downloaded to my downloads directory
    ...
    Then register_company_profile_button should be present