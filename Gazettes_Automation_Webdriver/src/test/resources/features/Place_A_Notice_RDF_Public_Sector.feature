Feature: (GA-049) Select place notice as Organisational user – Central Gov’t 
	In order to place Gazette notices, I want to be able to select RDF template submission
...
Scenario: Login and check if I can place a notice 
	...
	And I update the rdf file \\place_a_notice\\2903 - valid.rdf to have the correct publication date
	And I upload the file \\place_a_notice\\2903 - valid.rdf to template_chooseDoc_button 
