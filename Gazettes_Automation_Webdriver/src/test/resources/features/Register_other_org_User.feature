Feature: (GA-023) Register other org user
  ...
  Scenario: Register other Org user
    Given I go to register as organisation user
    And I fill in the form
      | fieldName                | fieldValue                     | fieldType |
      | #organisation-name       | OTATN OFFICE SOLUTIONS LIMITED | text      |
      | #organisation-regno      | 10989709                       | text      |
    ...
    And I fill in #businessType as Insolvency practitioner
...
#    And I wait up to 2 minutes for temp_mail_subject to appear
    ...
    And I click verify_agency_address
    ...
    Then page_header_h1 should say You are not authorised to view this page