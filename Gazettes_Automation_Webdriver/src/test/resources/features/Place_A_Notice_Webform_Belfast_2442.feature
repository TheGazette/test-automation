Feature: 2442-Belfast Positive Scenario
  Verify that the users can place a 2442 webform notice on gazettes belfast edition
  ...
  Scenario Outline: Logging in and filling in the webform
    ...
    And I navigate to /my-gazette/place-notice/belfast/2442/online-form
    And I verify #this-legislation-1_legislation-legislationTitle is Article 84 of the Insolvency (Northern Ireland) Order 1989
    ...
    And I click 2442_signatory_job_title_joint_liquidators
    ...
    Then the text Joint Liquidator should be visible
