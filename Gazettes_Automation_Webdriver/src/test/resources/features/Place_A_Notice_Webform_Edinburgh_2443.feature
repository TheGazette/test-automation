Feature:2443 Webform - Edinburgh Positive Scenario
        Check whether users are able to place a 2443 webform notice in gazettes Edinburgh edition
  ...
  Scenario Outline: Logging in and filling in the webform
    ...
    Then the text By whom appointed: The Company should be visible
