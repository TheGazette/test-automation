Feature: (GA-044,045,046) Select Excel Template upload as Organisational user – Public Sector 
...
Scenario Outline: Login and check if I can place a notice and pay with Card 
	...
	| cgorg_css@mailhog.com		| _password_			|	\\place_a_notice\\2904 downloaded from staging.xls	|
	| cgorg_css@mailhog.com		| _password_			|	\\place_a_notice\\2904 live GLD Data.xls			|
	| cgorg_css@mailhog.com		| _password_			|	\\place_a_notice\\gazette-template-2904.xls			|
