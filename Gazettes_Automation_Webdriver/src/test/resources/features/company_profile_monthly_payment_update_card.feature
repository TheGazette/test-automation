Feature: Changing the card details used for recurring payments in company profile

  Scenario: Creating a random company profile with monthly payment and updating card
...
#    And I wait up to 2 minutes for temp_mail_subject to appear
    ...
    And I wait for 5 seconds
    And I click update_card_button
    And I wait for 5 seconds
    And I select update_card_drop_down_menu from update_card_actions_button
    And I wait for 1 minutes
    And I fill in the form
      | fieldName   | fieldValue       | fieldType |
      | card_number | 4444444444444471 | text      |
    And I wait for 20 seconds
    And I fill in the form
      | fieldName          | fieldValue | fieldType |
      | card_security_code | 000        | text      |
    ...
    And I click continue_payment
    And I wait for 1 minutes
    And I verify card_detail_update_status contains text PAYMENT DETAILS UPDATED
