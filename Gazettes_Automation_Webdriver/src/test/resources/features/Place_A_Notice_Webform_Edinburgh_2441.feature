Feature:  Verifying that the following users are able to place a 2441 webform notice in gazettes edinburgh edition.
  ...
  Scenario Outline: Logging in and placing 2441 notice.
    ...
    And I navigate to /my-gazette/place-notice/edinburgh/2441/online-form
    ...
    And I click 2441_type_of_meeting_extraordinary
    And I click 2441_meeting_details_attendees
    And I click 2441_meeting_details_attendees_members
    And I fill in the form
      | fieldName                                                | fieldValue | fieldType |
    ...
    And I click 2441_signatory_job_director
