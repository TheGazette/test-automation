Feature: 2443 Webform - London Positive Scenario
  Check whether users are able to place a 2443 webform notice in gazettes london edition
  ...
  Scenario Outline: Logging in and filling in the webform
    ...
    And I navigate to /my-gazette/place-notice/london/2443/online-form
    ...
    And I click 2443_appointed_by_creditors
    ...
    Then the text By whom appointed: Creditors should be visible
    Then the text someAdditionalInfo should be visible
    And I verify 2443_verify_additional_info is someAdditionalInfo
