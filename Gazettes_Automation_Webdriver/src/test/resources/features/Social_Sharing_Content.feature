Feature: (GA-010,011) Social sharing from resources content page
	In order to check social sharing functionlity, I want to be able to select that option
  
  Scenario: Social Sharing-copy to clipboard functionlity
   Given I am on the site homepage
   When I click all_notices
   And I click see_all_resources
   And I click first_item_in_resources_feed
   And I click social_sharing_tool
   And I click social_link_button
   Then link_lable_text should say Link to this Gazette content
 ...
 Scenario: Social Sharing-send email functionlity
   ...
   Then send_noticedByEmail_text should say Send a link to this Gazette content by email
