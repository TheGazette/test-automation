Feature: 2443 Webform Edinburgh Negative Scenario

  Scenario: Fill in the webform with negative inputs and validate errors

    Given I am logged in as RegressionTestAdvtAgency@mailhog.com, with a password of Williams#1
    And I empty the basket if not empty before I add more items
    And I navigate to /my-gazette/place-notice/edinburgh/2443/online-form
    And I verify #this-legislation-1_legislation-legislationTitle is Insolvency Act 1986 (S.100 & S.109)
...
#    And I click 2443_company_type_overseas
    ...
    And I click 2443_appointed_by_company
    And I click 2443_court_name_drop_down
    And I click 2443_court_name_county_court
    And I click 2443_court_case_number_format_drop_down
    And I click 2443_case_number_format_BR
    And I fill in the form
      | fieldName                                                 | fieldValue         | fieldType |
