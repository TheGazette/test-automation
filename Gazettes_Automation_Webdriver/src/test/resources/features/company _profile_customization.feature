Feature: Changing director details - In company profile should not affect company profile customizations

  Scenario: Changing director details in company profile and checking profile customizations
