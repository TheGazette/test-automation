Feature: 2446 webform Edinburgh Negative Scenario

  Scenario: Fill the webform with wrong inputs and validate the errors
    Given I am logged in as RegressionTest38@mailhog.com, with a password of Williams#1
    ...
    And I fill in the form
      | fieldName                                                            | fieldValue               | fieldType |
      | #this-notifiableThing_corp-insolvency-onOrBeforeProvingDebts         | 10                       | date      |
      ...
      | #this-notifiableThing_corp-insolvency-dateOfAppointment-1            | 10                       | date      |
