Feature: Verifying that the following users are able to place a 2441 webform notice in gazettes london edition.
  ...
  Scenario Outline: Logging in and placing 2441 notice.
    ...
    And I navigate to /my-gazette/place-notice/london/2441/online-form
    And I verify #this-legislation-1_legislation-legislationTitle is The Insolvency Act 1986 (S.84)
    ...
    And I wait for 2 seconds
    And I click 2441_meeting_details_type_drop_down
    And I click 2441_type_of_meeting_special
    ...
    And I fill in #this-meetingAddress-1_vcard-postal-code-1 as ME2 2LA
    And I click 2441_physical_meeting_post_code_lookup_link
    And I wait for 2 seconds
    And I click 2441_physical_meeting_address_search_result
    And I click 2441_physical_meeting_address_select
